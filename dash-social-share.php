...
Plugin URI: https://github.com/marcelbadua/dash-social-share
...
if (!class_exists('DASH_SOCIAL_SHARE')) {
    class DASH_SOCIAL_SHARE
    {
        ...
        //https://github.com/radishconcepts/WordPress-GitHub-Plugin-Updater/blob/master/plugin.php
        public function github_plugin_updater_test_init() {
           ...
           if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
        		$config = array(
        			...
        			'zip_url' => 'https://github.com/marcelbadua/dash-social-share/archive/master', // the zip url of the GitHub repo
